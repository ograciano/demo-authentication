# auth-initial-permission-assignment-idempotency Specification

## Purpose
TBD - created by archiving change hu-04-asignacion-permiso-inicial-idempotente. Update Purpose after archive.
## Requirements
